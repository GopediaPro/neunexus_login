...
export const InfoSidebarLayout = () => {
  return (
    <div className={`min-w-[288px] w-sidebar-right 2xl:w-sidebar-right-2xl h-full bg-fill-base-100 p-1 shadow-xl border border-stroke-base-100 rounded-md flex flex-col`}>
