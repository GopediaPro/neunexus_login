    ...
    <Modal isOpen={isOpen} onClose={onClose} size="2xl">
      ...
      <Modal.Body>
        <div className="space-y-4 w-full">
          ...
          <div className="flex flex-col gap-4 max-h-96 overflow-y-auto overflow-x-hidden w-full">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-text-base-500">
                            ...
                            <div className="flex items-center gap-1">
                              <div className={`w-2 h-2 rounded-full ${batch.error_message ? 'bg-error-500' : 'bg-success-500'}`}></div>
                              <span className={batch.error_message ? 'text-error-500' : 'text-success-500'}>
